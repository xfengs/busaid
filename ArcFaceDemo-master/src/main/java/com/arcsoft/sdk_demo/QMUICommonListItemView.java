...
public class QMUICommonListItemView extends RelativeLayout {
    ...
    public QMUICommonListItemView(Context context, AttributeSet attrs) {
        this(context, attrs, com.qmuiteam.qmui.R.attr.QMUICommonListItemViewStyle);
    }
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr) {
        LayoutInflater.from(context).inflate(com.qmuiteam.qmui.R.layout.qmui_common_list_item, this, true);

        TypedArray array = context.obtainStyledAttributes(attrs, com.qmuiteam.qmui.R.styleable.QMUICommonListItemView, defStyleAttr, 0);
        @QMUICommonListItemOrientation int orientation = array.getInt(com.qmuiteam.qmui.R.styleable.QMUICommonListItemView_qmui_orientation, HORIZONTAL);
        @QMUICommonListItemAccessoryType int accessoryType = array.getInt(com.qmuiteam.qmui.R.styleable.QMUICommonListItemView_qmui_accessory_type, ACCESSORY_TYPE_NONE);
        final int initTitleColor = array.getColor(com.qmuiteam.qmui.R.styleable.QMUICommonListItemView_qmui_commonList_titleColor, QMUIResHelper.getAttrColor(getContext(), com.qmuiteam.qmui.R.attr.qmui_config_color_gray_1));
        final int initDetailColor = array.getColor(com.qmuiteam.qmui.R.styleable.QMUICommonListItemView_qmui_commonList_detailColor, QMUIResHelper.getAttrColor(getContext(), com.qmuiteam.qmui.R.attr.qmui_config_color_gray_5));
        array.recycle();

        mImageView = (ImageView) findViewById(com.qmuiteam.qmui.R.id.group_list_item_imageView);
        mTextContainer = (LinearLayout) findViewById(com.qmuiteam.qmui.R.id.group_list_item_textContainer);
        mTextView = (TextView) findViewById(com.qmuiteam.qmui.R.id.group_list_item_textView);
        mTextView.setTextColor(initTitleColor);
        mRedDot = (ImageView) findViewById(com.qmuiteam.qmui.R.id.group_list_item_tips_dot);
        mNewTipViewStub = (ViewStub) findViewById(com.qmuiteam.qmui.R.id.group_list_item_tips_new);
        mDetailTextView = (TextView) findViewById(com.qmuiteam.qmui.R.id.group_list_item_detailTextView);
        mTextDetailSpace = (Space) findViewById(com.qmuiteam.qmui.R.id.group_list_item_space);
        ...
        if (QMUIViewHelper.getIsLastLineSpacingExtraError()) {
            detailTextViewLP.bottomMargin = -QMUIResHelper.getAttrDimen(context, com.qmuiteam.qmui.R.attr.qmui_common_list_item_detail_line_space);
        }
        ...
        mAccessoryView = (ViewGroup) findViewById(com.qmuiteam.qmui.R.id.group_list_item_accessoryView);
    ...
    public void setOrientation(@QMUICommonListItemOrientation int orientation) {
        ...
        if (mOrientation == VERTICAL) {
            ...
            spaceLp.weight = 0;
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_title_v_text_size));
            mDetailTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_detail_v_text_size));
        } else {
            ...
            spaceLp.height = 0;
            spaceLp.weight = 1;
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_title_h_text_size));
            mDetailTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_detail_h_text_size));
        }
    }
    ...
    public void setAccessoryType(@QMUICommonListItemAccessoryType int type) {
        ...
        switch (type) {
            ...
            case ACCESSORY_TYPE_CHEVRON: {
                ...
                tempImageView.setImageDrawable(QMUIResHelper.getAttrDrawable(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_chevron));
            ...
            case ACCESSORY_TYPE_SWITCH: {
                if (mSwitch == null) {
                    ...
                    mSwitch.setButtonDrawable(QMUIResHelper.getAttrDrawable(getContext(), com.qmuiteam.qmui.R.attr.qmui_common_list_item_switch));
