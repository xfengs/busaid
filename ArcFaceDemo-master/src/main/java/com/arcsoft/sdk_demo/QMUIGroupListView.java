 ...
 * </p>
 * <p>
 * 提供了 {@link Section} 的概念, 用来将列表分块。 具体见 {@link com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView.Section}
 * </p>
 * <p>
 * usage:
 * <pre>
...
public class QMUIGroupListView extends LinearLayout {
    ...
    /**
     * private, use {@link Section#addTo(com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView)}
    ...
    /**
     * private，use {@link Section#removeFrom(com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView)}
    ...
    /**
     * Section 是组成 {@link com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView} 的部分。
     * <ul>
     ...
     * </ul>
     */
    public static class Section extends com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView.Section {
        ...
        public void singleCheck(CompoundButton buttonView, boolean isChecked){

            if(isChecked==true) {
                for (int i = 0; i < mItemViews.size(); i++) {
                    if(buttonView != mItemViews.get(i).getSwitch())
                    {
                        if(mItemViews.get(i).getSwitch().isChecked()==true){
                            mItemViews.get(i).getSwitch().toggle();
                        }
                    }
                }
            }
        ...
        /**
         * 将 Section 添加到 {@link com.qmuiteam.qmui.widget.grouplist.QMUIGroupListView} 上
         */
        public void addTo(com.arcsoft.sdk_demo.QMUIGroupListView groupListView) {
            if (mTitleView == null) {
        ...
        public void removeFrom(com.arcsoft.sdk_demo.QMUIGroupListView parent) {
